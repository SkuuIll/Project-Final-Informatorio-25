...
def dashboard_view(request):
    ...
    chart_data_points = [
        5, 10, 8, 15, 12, 18, 20, 25, 22, 30, 35, 40, 38, 45, 50, 
        48, 55, 60, 58, 65, 70, 68, 75, 80, 78, 85, 90, 88, 95, 100
    ]
...
def favorite_list(request):
    ...
    return render(request, 'posts/favorite_list.html', {'favorite_posts': favorite_posts})
